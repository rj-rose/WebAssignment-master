...
namespace WebAssignment.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IUserStore<WebAssignmentUser> userStore,
            SignInManager<WebAssignmentUser> signInManager,
        ...
        private WebAssignmentUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<WebAssignmentUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(WebAssignmentUser)}'. " +
                    $"Ensure that '{nameof(WebAssignmentUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private async Task<bool> SendEmailAsync(string email, string subject, string confirmLink)
        {
            try
            {
                ...
                message.From = new MailAddress("noreplymarketplace.ca");
                ...
                smtpClient.Port = 707;
                smtpClient.Host = "smtp.simply.ca";
        ...
        private IUserEmailStore<WebAssignmentUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<WebAssignmentUser>)_userStore;
        }
    }
}
